...
<html lang="en">
	...
	<head>
		...
		<link href="<?= themes_url('custom') ?>/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />

		<!--end::Page Vendors Styles -->

		<!--begin:: Global Mandatory Vendors -->
		<link href="<?= themes_url('general') ?>/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" type="text/css" />

		<!--end:: Global Mandatory Vendors -->

		<!--begin:: Global Optional Vendors -->
		<link href="<?= themes_url('general') ?>/tether/dist/css/tether.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-datetime-picker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/select2/dist/css/select2.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/nouislider/distribute/nouislider.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/owl.carousel/dist/assets/owl.carousel.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/owl.carousel/dist/assets/owl.theme.default.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/summernote/dist/summernote.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('general') ?>/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" type="text/css" />
		...
		<link href="<?= themes_url('general') ?>/morris.js/morris.css" rel="stylesheet" type="text/css" />
		...
		<link href="<?= themes_url('demo4') ?>/base/style.bundle.css" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="<?= themes_url('media') ?>/logos/favicon.ico" />
	</head>

	<!-- end::Head -->

	<!-- begin::Body -->
	<body style="background-image: url(../assets/demo/demo4/media/bg/header.jpg)" class="kt-page--loading-enabled kt-page--loading kt-page--fixed kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="index.html">
					<img alt="Logo" src="<?= themes_url('media') ?>/logos/logo-4-sm.png" />
				</a>
			</div>
						...
						<div class="kt-container">
							...
							<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
								<a class="kt-header__brand-logo" href="index.html">
									<img alt="Logo" src="<?= themes_url('media') ?>/logos/logo-4.png" class="kt-header__brand-logo-default" />
									<img alt="Logo" src="<?= themes_url('media') ?>/logos/logo-4-sm.png" class="kt-header__brand-logo-sticky" />
								</a>
							</div>
							...
							<div class="kt-header__topbar kt-grid__item">
								...
								<div class="kt-header__topbar-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
										<form>
											...
											<!--begin: Head -->
											<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(<?= themes_url('media') ?>/misc/bg-1.jpg)">
								...
								<div class="kt-header__topbar-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
										<form>
											...
											<!--begin: Head -->
											<div class="kt-head kt-head--skin-dark" style="background-image: url(<?= themes_url('media') ?>/misc/bg-1.jpg)">
												<h3 class="kt-head__title">
													User Quick Actions
													...
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="<?= themes_url('media') ?>/products/product9.jpg" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="<?= themes_url('media') ?>/products/product13.jpg" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="<?= themes_url('media') ?>/products/product16.jpg" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="<?= themes_url('media') ?>/products/product15.jpg" title="" alt="">
															</a>
														</div>
													</div>
												</div>
								...
								<div class="kt-header__topbar-item kt-header__topbar-item--langs">
									<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
										<span class="kt-header__topbar-icon">
											<img class="" src="<?= themes_url('media') ?>/flags/020-flag.svg" alt="" />
										</span>
									</div>
										...
										<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
											<li class="kt-nav__item kt-nav__item--active">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="<?= themes_url('media') ?>/flags/020-flag.svg" alt="" /></span>
													<span class="kt-nav__link-text">English</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="<?= themes_url('media') ?>/flags/016-spain.svg" alt="" /></span>
													<span class="kt-nav__link-text">Spanish</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="<?= themes_url('media') ?>/flags/017-germany.svg" alt="" /></span>
														...
														<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
															...
															<div class="kt-timeline-v2__item">
																...
																<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
																	<a href="#"><img src="<?= themes_url('media') ?>/users/100_4.jpg" title=""></a>
																	<a href="#"><img src="<?= themes_url('media') ?>/users/100_13.jpg" title=""></a>
																	<a href="#"><img src="<?= themes_url('media') ?>/users/100_11.jpg" title=""></a>
																	<a href="#"><img src="<?= themes_url('media') ?>/users/100_14.jpg" title=""></a>
																</div>
															</div>
															<div class="kt-timeline-v2__item">
														...
														<div class="kt-widget4__items kt-widget4__items--bottom kt-portlet__space-x kt-margin-b-20">
															<div class="kt-widget4__item">
																<div class="kt-widget4__img kt-widget4__img--logo">
																	<img src="<?= themes_url('media') ?>/client-logos/logo3.png" alt="">
																</div>
															...
															<div class="kt-widget4__item">
																<div class="kt-widget4__img kt-widget4__img--logo">
																	<img src="<?= themes_url('media') ?>/client-logos/logo1.png" alt="">
																</div>
																<div class="kt-widget4__info">
																	<a href="#" class="kt-widget4__title">
																		FlyThemes
															...
															<div class="kt-widget4__item">
																<div class="kt-widget4__img kt-widget4__img--logo">
																	<img src="<?= themes_url('media') ?>/client-logos/logo2.png" alt="">
																</div>
																<div class="kt-widget4__info">
																	<a href="#" class="kt-widget4__title">
																		AirApp
			...
			<div class="kt-demo-panel__body">
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-_Default.jpg" alt="" />
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-2.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-3.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item kt-demo-panel__item--active">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-4.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-5.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-6.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-7.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-8.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-9.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-10.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-11.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-12.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-13.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?= themes_url('media') ?>/demos/Demo-14.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
