...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Google Maps</title>
		<meta name="description" content="Google maps examples">
		...
		<link href="<?= themes_url('default') ?>/base/style.bundle.css" rel="stylesheet" type="text/css" />

		<!--end::Global Theme Styles -->

		<!--begin::Layout Skins(used by all pages) -->
		<link href="<?= themes_url('default') ?>/skins/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('default') ?>/skins/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('default') ?>/skins/brand/dark.css" rel="stylesheet" type="text/css" />
		<link href="<?= themes_url('default') ?>/skins/aside/dark.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
            ...
            -->
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<!-- end:: Subheader -->
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="bondoyudo" style="width:100%;height:768px;background-color: #fffeee">
						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
									<b>gmaps.js</b> is a google maps api with less pain and more fun.
									For more info please check out <a class="kt-link kt-link--brand kt-font-bold" href="https://hpneo.github.io/gmaps/" target="_blank">the official documentation.</a>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<form class="form-inline kt-margin-b-10" action="#">
												<input type="button" id="kt_gmap_7_btn" class="btn btn-success" value="Start Routing" />
											</form>
											<div id="kt_gmap_7" style="height:300px;">
											</div>
											<ol id="kt_gmap_7_routes">
											</ol>
										</div>
									</div>
									...
									<div class="kt-portlet kt-portlet--tab">
										...
										<div class="kt-portlet__body">
											<form class="kt-margin-b-20" action="#">
												<div class="input-group">
													<input type="text" class="form-control" id="kt_gmap_8_address" placeholder="address...">
													<div class="input-group-append">
														<button class="btn btn-primary" id="kt_gmap_8_btn"><i class="fa fa-search"></i></button>
													</div>
												</div>
											</form>
											<div id="kt_gmap_8" style="height:300px;">
											</div>
										</div>
									</div>
		...
		<ul class="kt-sticky-toolbar" style="margin-top: 30px;">
			<li class="kt-sticky-toolbar__item kt-sticky-toolbar__item--success" id="kt_demo_panel_toggle" data-toggle="kt-tooltip" title="Maps Admin Panel" data-placement="right">
				<a href="#" class=""><i class="flaticon2-maps"></i></a>
			</li>
		...
		<script src="<?= themes_url('default') ?>/base/scripts.bundle.js" type="text/javascript"></script>
