...
<html lang="en">
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<script src="//maps.google.com/maps/api/js?key=AIzaSyDjOoVy_-7uVj0AfpgoNEG78wH7PEC6bkw" type="text/javascript"></script>
		<script src="<?= themes_url('custom')?>/gmaps/gmaps.js" type="text/javascript"></script>

		<!--end::Page Vendors -->

		<!--begin::Page Scripts(used by this page) -->
		<script src="bondoyudo-maps.js" type="text/javascript"></script>
