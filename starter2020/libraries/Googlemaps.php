...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDl0rUme5fegRNXzR8JzXGGs1ff6qkW7Jg'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function get_lat_long_from_address($address, $attempts = 0)
	{
		...
		$data_location .= "maps.google.com/maps/api/geocode/json?address=".urlencode(utf8_encode($address))."&callback=initMap";//.$this->sensor;
