...
<body>
	...
	<a class="waves-effect waves-light btn-large">By:-Bhargav</a>
		...
		<div class="row">	
			...
			<?php if(isset($_SESSION['name_google'])){?>
				<div class="col s12 m6 l4 offset-l3 " >
					<div class="card ">
			            <div class="card-image waves-effect waves-block waves-light">
			              <img class="activator" src="<?=$_SESSION['profile_pic_google']?>">
			            </div>
			            <div class="card-content">
			             <span class="card-title activator grey-text text-darken-4"> <i class="material-icons"><?=$_SESSION['name_google']?></i></span>
			            </div>
						 <div class="card-reveal">
      <span class="card-title grey-text text-darken-4"><?=$_SESSION['name_google']?><i class="material-icons right">close</i></span>
      <p>Email Id: <?=$_SESSION['email_google']?></p>
    </div>
			        </div>
				</div>
			<?php }?>
