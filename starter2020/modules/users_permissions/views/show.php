...
<div class="table-responsive">
    <table id="detail" class="table table-striped table-condensed">
        <tbody>
        <?php     
            foreach($users_permissions as $table => $value) :    
        ?>
        <tr>
	...
	<?php 
		...
		echo anchor(site_url('users_permissions'), '<span class="fa fa-chevron-left"></span> Kembali', 'class="btn btn-sm btn-default"');
